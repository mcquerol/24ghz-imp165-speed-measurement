// ======================================================================
// speed_sensor.v generated from TopDesign.cysch
// 06/28/2022 at 19:35
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("6c9b8ff1-b075-4286-a9ed-fd389b4c712c/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("6c9b8ff1-b075-4286-a9ed-fd389b4c712c/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module WaveDAC8_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("82f9a4fa-8792-4a6a-83d2-9eae7036813e/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Btn_startSample_net;
	wire [0:0] tmpFB_0__Btn_startSample_net;
	wire [0:0] tmpIO_0__Btn_startSample_net;
	electrical [0:0] tmpSIOVREF__Btn_startSample_net;
	...
	cy_psoc3_pins_v1_10
		...
		Btn_startSample
		 (.oe(tmpOE__Btn_startSample_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Btn_startSample_net[0:0]}),
		  .io({tmpIO_0__Btn_startSample_net[0:0]}),
		  .siovref(tmpSIOVREF__Btn_startSample_net),
		  .interrupt({Net_168}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Btn_startSample_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_1 UART (
        ...
        .rx_clk(Net_122),
        .rx_data(Net_123),
        .rx_interrupt(Net_171),
        .tx(Net_125),
        .tx_clk(Net_126),
        .tx_data(Net_127),
        .tx_en(Net_128),
        .tx_interrupt(Net_129));
	...
	cy_psoc3_pins_v1_10
		#(.id("d1677d80-de88-40de-8974-6fc8b1457983"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("66216193-c496-43b8-a0e1-d105916589cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("163d4133-a5a2-46ec-adc5-03f2a0189a10"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("57365adf-873b-4da1-a773-1eeb2e79746a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
